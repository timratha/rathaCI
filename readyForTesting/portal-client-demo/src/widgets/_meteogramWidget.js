define([
    ...
    'dijit/_WidgetBase',
    'dojo/_base/declare',
    'dojo/i18n!./nls/meteogramWidget',
    'dojo/text!./templates/meteogramWidget.html',
    'highcharts/highstock'
], function (WidgetsInTemplateMixin, TemplatedMixin, WidgetBase, declare,nls, template) {
 ...
 */
        drawWeatherSymbols: function (chart) {
    var meteogram = this,
        ...
        if (meteogram.resolution > 36e5 || i % 2 === 0) {
            ...
            if (sprite) {
                ...
                chart.renderer.image(
                     require.toUrl("portal")+"/widgets/images/meteogram-symbols-30px.png",
                    -sprite.x,
                    -sprite.y,
                    90,
                    570
 ...
 */
    ...
    var windScale = ['Calm', 'Light air', 'Light breeze', 'Gentle breeze', 'Moderate breeze',
        'Fresh breeze', 'Strong breeze', 'Near gale', 'Gale', 'Strong gale', 'Storm',
        'Violent storm', 'Hurricane'];

    level = windScale.indexOf(name);
 ...
 */
        getTitle: function () {
    return nls.meteogramTitle + this._jsonData.location.name + ', ' + this._jsonData.location.country;
},
 ...
 */
    ...
    this.chart.backgroundColor = '#D3D3D3';
},
 ...
 */
    ...
    if (!xml || !xml.forecast) {
        ...
        //console.debug('MeteogramWidget. Failed loading data, please try again later');
        throw new Error('MeteogramWidget. Failed loading data, please try again later');
        return;
    }
