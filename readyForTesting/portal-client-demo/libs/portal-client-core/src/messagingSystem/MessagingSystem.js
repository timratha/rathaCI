define([
    ...
    "dojo/dom-style",
    "dojo/dom-class"
], function (WidgetsInTemplateMixin, TemplatedMixin, WidgetBase, declare, template, nls, LayoutContainer, ContentPane,
    ...
    return declare([WidgetBase, TemplatedMixin, WidgetsInTemplateMixin], {
        ...
        postCreate: function () {
            ...
            PortalStore.messages.getSent().on("deleteM", function () {
                _t._showSentMessages();
            });
            PortalStore.messages.getTrash().on("deleteM", function () {
        ...
        _updateMessageCounter: function() {
            var _t = this;
            when(PortalStore.messages.getNew(), function (response) {
